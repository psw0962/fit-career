  ...
  const { error: insertError } = await supabase.from('resume').insert([
    {
      ...
      email: '',
      phone: '',
      introduction: `<p>다이어트와 체형 교정을 전문으로 5년간 500명 이상의 회원을 지도했습니다. 회원 개개인의 생활 습관과 목표에 맞춘 맞춤형 프로그램 설계를 강점으로, 3개월 평균 체지방 8% 감량 성과를 달성해 왔습니다. 운동이 습관이 될 수 있도록 심리적 동기부여를 병행하는 지도 방식을 지향합니다.</p>`,
      education: [],
      experience: [],
      certificates: [],
      awards: [],
