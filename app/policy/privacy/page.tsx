  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <pre className='text-sm break-keep whitespace-pre-wrap'>
...
법령의 규정에 의거하거나, 수사 목적으로 사회사의 요구가 있는 경우`}
      ...
      <div className='flex flex-col gap-2'>
        <p className='text-xl font-bold'>6. 개인정보의 안정성 확보조치에 관한 사항</p>
        <pre className='text-sm break-keep whitespace-pre-wrap'>{`1) 개인정보 암호화
2) 해킹 등에 대비한 대책
3) 취급 직원의 최소화 및 교육`}</pre>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <pre className='text-sm break-keep whitespace-pre-wrap'>{`성명: 박상우
...
`}</pre>
      ...
      <div className='flex flex-col gap-2'>
        <p className='text-xl font-bold'>8. 개인정보 취급방침 변경에 관한 사항</p>
        <pre className='text-sm break-keep whitespace-pre-wrap'>{`이 개인정보 취급방침은 2025년 2월 1일부터 적용됩니다.
