      ...
      <div className='mt-8'>
        <section>
          ...
          <ol className='list-decimal list-inside text-gray-700 mb-4 break-keep'>
            <li>
              채용 정보 관리: 무분별한 도배글과 낮은 품질의 채용정보 문제를 해결합니다. 피트니스
              기업은 채용 공고를 쉽게 등록 및 관리할 수 있고, 구직자는 편리하게 채용 정보를 확인할
              수 있습니다.
            </li>
            <li>
              커뮤니티 및 콘텐츠 제공: 양질의 정보를 한곳에 모아 커뮤니티를 형성하고 피트니스 관련
              콘텐츠를 제공하여 커리어 성장에 도움을 줍니다.
            </li>
            <li>
